...
public class PcKeyMap {
    ...
    static {
        mMap.put((int)'m', KEYCODE_MENU);
        mMap.put((int)'h', KEYCODE_HOME);
        mMap.put((int)'b', KEYCODE_BACK);
        mMap.put(SWT.KEYPAD_ADD, KEYCODE_VOLUME_UP);
        mMap.put(SWT.KEYPAD_SUBTRACT, KEYCODE_VOLUME_DOWN);
        mMap.put((int)'p', KEYCODE_POWER);
    }

    public static String getDeviceKey(int pcKey) {
        Integer i = mMap.get(pcKey);
