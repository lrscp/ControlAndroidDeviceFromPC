...
public interface IDevice {
    ...
    /**
     * Must be released after device disconnected
     */
    ...
    public int execShellCmdWithExitCode(String cmd, StringBuilder response) throws TimeoutException, AdbCommandRejectedException, IOException;
}
